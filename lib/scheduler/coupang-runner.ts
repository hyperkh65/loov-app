...
1. 후킹 오프닝 1문단: "이 제품 추천해요" 식으로 시작하지 말고, 이 제품이 없어서/안 사서 지금 계속 보고 있는 손해나 불편이 뭔지부터 깨닫게 하는 문장으로 시작. 공감형/질문형/장면 묘사 등 매번 다른 방식으로. "안녕하세요", "오늘 소개할 상품은" 같은 밋밋한 인사말 절대 금지.
