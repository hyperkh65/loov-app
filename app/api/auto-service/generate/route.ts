...
<div style="font-weight:bold;margin:0 0 6px;color:#1a73e8;">1. [참고자료 기반 실제 궁금증]</div>
<div style="color:#555;">[구체적이고 정확한 답변 2-3문장]</div>
</div>
<div style="margin:0 0 18px;padding:14px;background-color:#f9f9f9;border:1px solid #eee;border-radius:8px;">
<div style="font-weight:bold;margin:0 0 6px;color:#1a73e8;">2. [참고자료 기반 실제 궁금증]</div>
<div style="color:#555;">[구체적이고 정확한 답변 2-3문장]</div>
</div>
<div style="margin:0 0 18px;padding:14px;background-color:#f9f9f9;border:1px solid #eee;border-radius:8px;">
<div style="font-weight:bold;margin:0 0 6px;color:#1a73e8;">3. [참고자료 기반 실제 궁금증]</div>
<div style="color:#555;">[구체적이고 정확한 답변 2-3문장]</div>
</div>
<div style="margin:0 0 18px;padding:14px;background-color:#f9f9f9;border:1px solid #eee;border-radius:8px;">
<div style="font-weight:bold;margin:0 0 6px;color:#1a73e8;">4. [참고자료 기반 실제 궁금증]</div>
<div style="color:#555;">[구체적이고 정확한 답변 2-3문장]</div>
</div>
<div style="margin:0 0 18px;padding:14px;background-color:#f9f9f9;border:1px solid #eee;border-radius:8px;">
<div style="font-weight:bold;margin:0 0 6px;color:#1a73e8;">5. [참고자료 기반 실제 궁금증]</div>
<div style="color:#555;">[구체적이고 정확한 답변 2-3문장]</div>
</div>
<div style="margin:0 0 18px;padding:14px;background-color:#f9f9f9;border:1px solid #eee;border-radius:8px;">
<div style="font-weight:bold;margin:0 0 6px;color:#1a73e8;">6. [참고자료 기반 실제 궁금증]</div>
<div style="color:#555;">[구체적이고 정확한 답변 2-3문장]</div>
</div>
</div>
